...
// =================================
// GET : DÉTAIL d'un seul tarif (SHOW)
// =================================
export const GET = handleApi(async (request, context) => { 
    ...
    const tarif = await tarifsCollection.findOne({ _id: objectId });
    ...
    // Succès : Renvoyer le document trouvé
    return NextResponse.json({ ...tarif, id: tarif._id });
});
